...
**Version Handling:**
- **Firmware Version:** From compile-time defines (`FW_VERSION_PROTO` = 1, `FW_VERSION_MAJOR` = 0, `FW_VERSION_MINOR` = 0, `FW_VERSION_PATCH` = 0)
- **Hardware Version:** From EEPROM `HW_VERSION` field (2 bytes: MSB, LSB)
