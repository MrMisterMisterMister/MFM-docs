...
This document provides a comprehensive overview of the Multiflexmeter 3.7.0 architecture using the C4 model, including system design, component interactions, and operational workflows.

## Architecture Documentation

The Multiflexmeter 3.7.0 architecture is documented using the C4 model at four levels:
...
- **Battery Life**: 6-12 months on 2× AA batteries (15-min interval)
