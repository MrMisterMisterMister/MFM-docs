...
:::caution[TTN Version]
This decoder uses the **TTN v2/Legacy format** (`Decoder(bytes, port)`). If you're using **The Things Stack (TTN v3)**, use the `decodeUplink(input)` format shown in the [TTN Setup Guide](/deployment/ttn-setup/#33-add-decoder-function) instead.
:::
